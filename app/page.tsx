...
export async function POST(req: NextRequest) {
  ...
  const res = await fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({
      ...
      system: `You are an institutional-grade real estate investment analyst specializing in Dubai off-plan properties. Given a project name, search for current information and return ONLY a valid JSON object — no markdown, no preamble.
